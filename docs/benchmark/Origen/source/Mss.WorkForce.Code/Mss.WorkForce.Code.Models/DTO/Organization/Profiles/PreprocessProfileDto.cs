...
{
    public class PreprocessProfileDto : PenelEditorOperations, IDataOperation
    {
        ...
        [DisplayAttributes(2, "Preprocess type", true, Web.Model.Enums.ComponentType.TextBox, "", Web.Model.Enums.GroupTypes.None, false, true, true)]
        [ValidationAttributes(Enums.ValidationType.None)]
        ...
        {
            if (obj is not PreprocessProfileDto preprocessProfile)
                return false;

            return Id == preprocessProfile.Id &&
            Name == preprocessProfile.Name &&
            Type == preprocessProfile.Type;
        }
