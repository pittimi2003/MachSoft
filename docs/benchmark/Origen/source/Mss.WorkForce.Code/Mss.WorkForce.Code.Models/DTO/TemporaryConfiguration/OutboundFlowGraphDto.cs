...
{
    public class OutboundFlowGraphDto
    {
        ...
        [DisplayAttributes(5, "Partial closed", true, ComponentType.CheckBox, isVisibleDefault: true)]
        ...
        [DisplayAttributes(7, "Security Load Time", required: false, ComponentType.DropDown, isVisibleDefault: false, isVisible: false)]
        public double? SecurityLoadTime { get; set; }

        [DisplayAttributes(8, "MaxVehicleTime", true, ComponentType.NumericSpin, isVisibleDefault: true)]
        public double MaxVehicleTime { get; set; }

        public static OutboundFlowGraphDto NewDto()
        {
