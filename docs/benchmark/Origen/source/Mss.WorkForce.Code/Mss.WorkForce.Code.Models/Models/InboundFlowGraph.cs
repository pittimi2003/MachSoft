...
{
	public class InboundFlowGraph : IFillable, ICloneable
    {
        ...
        public object Clone()
        {
            InboundFlowGraph clonedInboundFlowGraph = (InboundFlowGraph)this.MemberwiseClone();
            clonedInboundFlowGraph.Id = Guid.NewGuid();
            return clonedInboundFlowGraph;
        }
    }
}
